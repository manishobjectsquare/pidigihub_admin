...
export default function LibraryBookingList() {
  ...
  const fetchBookings = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${baseUrl}/library-booking`, {
        method: "GET",
        headers: {
    ...
    if (result.isConfirmed) {
      try {
        const response = await fetch(
          `${baseUrl}/library-booking/update-status/${bookingId}`,
          {
            method: "PATCH",
            headers: {
                  ...
                  <div className="row align-items-center">
                    <div className="col-lg-6">
                      <h5 className="card-title">
                        Bookings List ({filteredBookings.length} of{" "}
                        {totalBookings})
                      </h5>
                    </div>
                    ...
                    <div className="col-12 col-md-6 col-lg-4">
                      <div className="responsive-search-box position-relative">
                        ...
                        <input
                          ...
                          placeholder="Search by user name, email, or library..."
                          value={searchTerm}
                          ...
                          <tr key={booking._id}>
                            ...
                            <td>
                              <span className="library-name">
                                {booking.libraryId?.libraryName || "N/A"}
                              </span>
                            </td>
                            <td>
