...
export default function PackagePurchaseList() {
  ...
  const fetchBookings = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${baseUrl}/packages/purchases-list`, {
        method: "GET",
        headers: {
    ...
    if (result.isConfirmed) {
      try {
        const response = await fetch(
          `${baseUrl}/packages/update-status/${bookingId}`,
          {
            method: "PATCH",
            headers: {
                      ...
                      {loading ? (
                        <tr>
                          <td colSpan="7" className="loading-spinner">
                            ...
                            <p className="mt-2">Loading Package...</p>
                          </td>
                        </tr>
                          ...
                          <td colSpan="7" className="empty-state">
                            ...
                            <p className="text-muted">
                              {searchTerm || statusFilter || paymentMethodFilter
                                ...
                                : "No Package Purchase available at the moment"}
                            </p>
                          </td>
                        </tr>
                      ) : (
