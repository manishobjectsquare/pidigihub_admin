...
export default function EditLibrary() {
  ...
  const handleInputChange = (e) => {
    ...
    if (name === "adminCommissionType" || name === "adminCommissionValue") {
      setFormData((prev) => ({
        ...prev,
        adminCommission: {
          ...prev.adminCommission,
          [name === "adminCommissionType" ? "type" : "value"]: value,
        },
      }));
    } else {
      setFormData((prev) => ({
                ...
                <div className="row mb-4">
                  ...
                  {/* <div className="col-md-6 mb-3">
                                        ...
                                        {existingPhotoUrl && !libraryPhoto && (
                                            <small className="text-muted d-block mt-1">Current photo: {existingPhotoUrl}</small>
                                        )}
                                        {libraryPhoto && (
                  ...
                  <div className="col-md-12 mb-3">
                    ...
                    >
                      {existingPhotoUrl && !libraryPhoto ? (
                        ...
                        <img
                          src={URL.createObjectURL(libraryPhoto)}
                          alt="Selected"
                          className="img-fluid rounded shadow-sm"
                          style={{ maxHeight: "180px", objectFit: "cover" }}
                        />
                    ...
                    <input
                      ...
                      onChange={(e) => setLibraryPhoto(e.target.files[0])}
                    />
