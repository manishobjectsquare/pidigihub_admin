...
export default function EditSubject() {
    ...
    const fetchSubjectData = async () => {
        try {
            ...
            if (response.data.status) {
                ...
                Swal.fire({
                    title: "Error!",
                    text: "Failed to fetch subject data",
                    icon: "error",
                })
            }
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.patch(`${baseUrl}/subject/update/${id}`, formData, {
                headers: {
                    Authorization: localStorage.getItem("token"),
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="cards text-center py-5">
                                ...
                                <p className="mb-4">The subject you are trying to edit does not exist or has been deleted.</p>
